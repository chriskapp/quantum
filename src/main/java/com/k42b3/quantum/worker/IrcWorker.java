...
/**
 * Worker which connects to an irc network joins a channel and redirects all 
 * incomming messages into the queue
 *
 * @author  Christoph Kappestein <k42b3.x@gmail.com>
 * @license http://www.gnu.org/licenses/gpl.html GPLv3
 * @link    https://github.com/k42b3/quantum
 */
public class IrcWorker extends WorkerAbstract
{
	public IrcWorker(Queue queue, Worker worker)
	{
		super(queue, worker);
	}
